...
public class Reminder extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * Adding spinner to screen
		 */
		items = new String[] {"NONE", "WEEKLY", "MONTHLY", "YEARLY"};
		spinner = (Spinner) findViewById(R.id.repeat_spinner);
		TextView textview = (TextView) findViewById(R.id.occurrencedata);
		
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
		            android.R.layout.simple_spinner_item, items);
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		spinner.setAdapter(adapter);
		spinner.setOnItemSelectedListener(new SpinnerItemSelectedListener(this,textview));
	...
	public void saveReminder(View view) {
		...
		if (null != reminderId) {
			...
			ReminderObject reminderObj = factoryObject.CreateReminderObject(
					...
					reminderNote.getText().toString(),SpinnerItemSelectedListener.occurrence,2);
	...
	public void editReminderMode(Intent intent){
		...
		int occurrence = intent.getIntExtra("com.codersarecreators.reminderOccurrence", 0);
		//spinner.setSelected(false);
		spinner.setSelection(occurrence);
	...
	public void setAlarm(ReminderObject reminderObject){
		
		 Calendar calendar = Calendar.getInstance();
	     String date = reminderObject.getDate();
	     StringTokenizer st = new StringTokenizer(date, "-");
	      ...
	      String time = reminderObject.getTime();
	      StringTokenizer timeToken = new StringTokenizer(time, " : ");
			int hr = Integer.parseInt(timeToken.nextToken());
	      ...
	      intent.setAction("com.codersarecreators.CUSTOM_INTENT");
	      intent.putExtra("com.codersarecreators.notes", reminderObject.getNote());
	     /* When you get a PendingIntent using getBroadcast(), this Intent will be broadcast to BroadcastReceivers.*/
